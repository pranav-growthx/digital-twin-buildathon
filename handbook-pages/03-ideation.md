...
Give **[IDEATION.md](starter-files/IDEATION.md)** to Claude / ChatGPT — it contains the rules your AI follows for the ideation interview. Copy or download it and paste it into the chat.
...
2. Give it the **`IDEATION.md`** rules — copy or download them from the starter files and paste them into the chat.
...
5. It writes you a **`PERSONA.md`** — your voice in one file. Save it into your `my-twin` folder.
...
When you have a saved `PERSONA.md`, a name, and a language, you're ready to build.
